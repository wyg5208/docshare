...
#### 首页背景图与文档封面图 🖼️
- ✅ 首页 Hero 区域支持三种背景模式：CSS 渐变（默认）/ Unsplash 预设图片 / 自定义上传
- ✅ 有背景图时文字自动切换白色，确保可读性
- ✅ 文档卡片支持三种封面模式：默认图标 / 纯色背景+图标 / 预设或自定义图片
- ✅ Admin 站点设置页 Hero Tab 新增背景图选择（含实时预览）
- ✅ Admin 文档新建/编辑页新增 Cover Image 设置
- ✅ 可复用 ImageUploadPicker 组件（支持 None/Color/Preset/Upload 四种模式）
- ✅ 12 张教育主题预设图 + 12 种预设颜色

### 技术改进
- 📝 数据库 Migration 008：documents 表新增 cover_color 列 + site_settings 新增 hero_bg 设置
- 🎨 复用现有 thumbnail_url 字段，最小化数据库变更

> 详见：[docs/v1.7.0_2026-06-25_首页背景图与文档封面图功能.md](docs/v1.7.0_2026-06-25_首页背景图与文档封面图功能.md)
