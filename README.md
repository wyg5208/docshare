...
#### 移动端 PDF 预览修复 📄
- ✅ 将 iframe 方案替换为 react-pdf Canvas 渲染，修复移动端（iOS Safari / Android Chrome）无法在线阅读 PDF 的问题
- ✅ 支持逐页翻页导航、响应式宽度适配、CJK 字体渲染
- ✅ 修复预览容器 overflow-hidden 导致的内容裁剪
- ✅ PDF 加载失败时提供下载降级方案

> 详见：[docs/v1.9.1_2026-06-29_移动端PDF预览修复.md](docs/v1.9.1_2026-06-29_移动端PDF预览修复.md)
