...
#### 用户帮助入口 🆕
- ✅ 导航栏新增用户帮助图标（`?`），所有用户可便捷访问操作指南弹窗
- ✅ 弹窗包含 9 个帮助主题：入门、注册登录、浏览搜索、预览下载、收藏、设置、主题切换、FAQ

### 文档同步
- 📝 管理员操作指南同步更新 v1.3.0~v1.8.1 功能（用户有效期、4级权限、站点设置、文档封面图、活动日志）
- 📝 用户操作手册新增主题切换功能说明

> 详见：[docs/v1.8.2_2026-06-25_用户帮助手册入口与文档同步更新.md](docs/v1.8.2_2026-06-25_用户帮助手册入口与文档同步更新.md)
