...
#### 用户操作手册 📖
- ✅ 新增 Account Validity 小节，说明永久有效/期间有效两种模式
- ✅ 更新下载权限说明，反映 4 级权限模型的下载控制
- ✅ FAQ 新增 2 个条目：下载权限受限说明 + 账号过期处理指引

#### 管理员帮助弹窗 📋
- ✅ "Managing Users" 章节新增：物理删除用户、Time Permission 列、有效期编辑器说明
- ✅ "Managing Permissions" 章节更新：权限模型从 3 级扩展为 4 级（Only View → View & Download → Edit → Manage）

> 详见：[docs/v1.4.1_2026-06-25_用户操作手册与管理员帮助指南更新.md](docs/v1.4.1_2026-06-25_用户操作手册与管理员帮助指南更新.md)
